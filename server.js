...
const allowedOrigins = process.env.ALLOWED_ORIGINS 
  ...
  : ['http://localhost:3000', 'http://localhost:5173', 'https://liquidata.dev', 'https://www.liquidata.dev'];
...
app.use((req, res, next) => {
  ...
  const allowedOrigins = ['http://localhost:3000', 'http://localhost:5173', 'https://liquidata.dev', 'https://www.liquidata.dev'];
...
// Swagger setup
const blogsCaseStudiesSwagger = require('./swagger-blogs-casestudies');
